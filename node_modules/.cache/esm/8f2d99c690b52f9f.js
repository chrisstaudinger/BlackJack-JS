let Deck,getRandomInt;_90b‍.w("./cards.js",[["default",["Deck"],function(v){Deck=v}],["getRandomInt",["getRandomInt"],function(v){getRandomInt=v}]]);
...
const houseMove = (obj, opponent) => {
  ...
  _90b‍.g.console.log(inRoundSummary(obj))
  _90b‍.g.console.log(inRoundResultHouse(obj, opponent))
  }
}
...
const playerMoveMenu = (options) => {
  ...
  switch (userChoice) {
    case 0:
      ...
      calcAce(player)
      _90b‍.g.console.log(inRoundSummary(player))
      _90b‍.g.console.log(inRoundResult(player, house))
      playerMoveMenu(options)
      break;
    case 1:
      console.log("You have chosen to sit\n")
      _90b‍.g.console.log(houseMove(house, player))
  }
}
...
const inRoundResultHouse = (obj, opponent) => {
  if (cardTotalValue(obj) === 21) {
    ...
    _90b‍.g.console.log(calculateResult(obj, opponent))
  }
}


Deck.shuffle(30)
_90b‍.g.console.log(startGameMenu(startGameOptions))
